...
# Privacy Policy — X Spam Comment Filter
...
For privacy-related questions, please open an issue on [GitHub](https://github.com/frankwang0909/x-comment-filter-extension/issues).
...
如有隐私相关问题，请通过 [GitHub Issues](https://github.com/frankwang0909/x-comment-filter-extension/issues) 联系。
