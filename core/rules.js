...
const RULES = {
	...
	textPatterns: [
		...
		{ re: /找[\s\S]{0,3}炮[\s\S]{0,3}友/, label: '找炮友引流' },
		{ re: /私信(我|联系)/, label: '引流模板' },
		{ re: /点主页/, label: '引流模板' },
		{ re: /点[\s\S]{0,3}主[\s\S]{0,3}页/, label: '引流模板' },
		{ re: /主页有/, label: '引流模板' },
		{ re: /线下牵线/, label: '引流模板' },
		{ re: /主页自取/, label: '引流模板' },
		{ re: /主页进群/, label: '引流模板' },
		...
		// 全国安排机器人（正文含爪哇语字符 ꦿ，普通推文不会出现）
		{ re: /ꦿ/, label: '全国安排机器人' },
		// Tigris 相关刷量话术
		{ re: /讲课老帅是好教授/, label: 'Tigris刷量' },
	],
	...
	namePatterns: [
		...
		{
			re: /(找个搭子|找炮友|蹲一个弟弟|蹲个弟弟|蹲一个哥哥|蹲个哥哥|无🚪|寻男大固泡|男大固泡|看我主页|点主页|附近真实约见|真实约见|约见资源|附近资源自取|附近的?DD啊?|全推唯一真实约见|全网唯一约炮社区|点我头像选人|线下牵线|主页自取|主页进群|点我主页自取|点我主页进群|找主人|主人)/,
			label: '昵称导流词',
		},
		{ re: /同城无偿/, label: '昵称导流词' },
		{ re: /线下约见/, label: '昵称导流词' },
		{ re: /真实可靠/, label: '昵称导流词' },
		{ re: /点我头像/, label: '昵称导流词' },
		{ re: /全国[1一][-—~]?[5五]线覆盖/, label: '昵称导流词' },
		{ re: /来吃我大奶/, label: '昵称色情词' },
		{ re: /同城男单/, label: '昵称导流词' },
		{ re: /同城男大/, label: '昵称导流词' },
		{ re: /同城.*线下/, label: '昵称导流词' },
		{ re: /线下.*同城/, label: '昵称导流词' },
		{ re: /纯曰/, label: '昵称色情词' },
		{ re: /币圈/, label: '昵称割韭菜' },
		{ re: /返佣/, label: '昵称割韭菜' },
		{ re: /全天候/, label: '昵称导流词' },
